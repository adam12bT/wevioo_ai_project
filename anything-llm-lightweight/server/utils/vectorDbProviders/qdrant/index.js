...
// Restored from upstream Mintplex-Labs/anything-llm for the lightweight fork
// (it was pruned out along with the other non-Chroma vector stores — see
// CHANGES-lightweight-v2.md). Works with both a self-hosted Qdrant instance
// and Qdrant Cloud: point QDRANT_ENDPOINT at either, and set QDRANT_API_KEY
// when using Cloud (or a self-hosted instance with auth enabled).
